...
sealed class DestinationClass(protected val route: String, vararg params: String)
{
    ...
    data object HomeScreen: NoArgumentsDestination("HomeScreen")
    data object VerseReadingView: NoArgumentsDestination("VerseReadingView")
    data object AudioBible: NoArgumentsDestination("AudioBible")
}
